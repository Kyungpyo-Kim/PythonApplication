...
available_indicators = df_country_indicators['Indicator Name'].unique()
all_options = {
...
app.layout = html.Div([
    ...
    dcc.Slider(
        ...
        value=df_country_indicators['Year'].max(),
        marks={str(year): str(year) for year in df_country_indicators['Year'].unique()},
        step=None
    ),
...
def update_figure(selected_year):
    filtered_df = df_gapminder[df_gapminder.year == selected_year]
    traces = []
...
def update_graph(xaxis_column_name, yaxis_column_name,
                 ...
                 year_value):
    dff = df_country_indicators[df_country_indicators['Year'] == year_value]
